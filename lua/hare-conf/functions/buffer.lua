...
---@type table<string, HareConfEditorBuffer>
...
--- @return HareConfEditorBuffer|nil The editor buffer configuration for the given filetype, or
---     nil if none is set.
...
--- @return HareConfEditorBuffer The merged editor buffer configuration.
...
--- @param buffer_config HareConfEditorBufferInput The editor buffer configuration to set/merge in.
...
---
--- @return HareConfEditorBuffer[] List of buffer configurations.
